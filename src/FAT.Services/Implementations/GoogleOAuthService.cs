...
public class GoogleOAuthService : IGoogleOAuthService
{
    ...
    public async Task<GoogleOAuthResult> AuthenticateWithGoogleAsync(CancellationToken cancellationToken = default)
    {
        ...
        var responseString = "<html><head><meta charset='utf-8'/></head><body style='font-family:sans-serif;text-align:center;padding-top:50px;'><h2>Xác thực Google thành công!</h2><p>Bạn có thể đóng cửa sổ này và quay lại ứng dụng FAT.</p><script>setTimeout(function(){window.close();}, 1500);</script></body></html>";
