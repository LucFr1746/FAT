...
{
    public static IServiceCollection AddFatData(this IServiceCollection services, string connectionString)
    {
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            throw new ArgumentException(
                "Connection string is empty. Check ConnectionStrings:FatDatabase in appsettings.json.",
        ...
        // its own context.
        services.AddDbContext<FatDbContext>(options =>
        {
