...
/// <summary>
/// Builds in-memory <see cref="FatDbContext"/> instances for unit tests.
///
...
public static class TestDb
{
    ...
    public static FatDbContext Create()
    {
    ...
    public static Major AddMajor(this FatDbContext db, string code = "SE", string? name = null)
    {
        var major = new Major
        {
            MajorCode = code,
    ...
    public static Course AddCourse(
        this FatDbContext db, string code, int credits = 3, bool countsTowardGpa = true)
    {
    ...
    public static Curriculum AddCurriculumItem(
        this FatDbContext db, int majorId, int courseId, int termNo, int displayOrder = 0)
    {
    ...
    public static Semester AddSemester(
        this FatDbContext db, string code, int displayOrder, bool isCurrent = false)
    {
    ...
    public static Student AddStudent(this FatDbContext db, int majorId, string code = "SE000001")
    {
    ...
    public static Prerequisite AddPrerequisite(
        this FatDbContext db, int courseId, int requiredCourseId, int groupNo = 0)
    {
